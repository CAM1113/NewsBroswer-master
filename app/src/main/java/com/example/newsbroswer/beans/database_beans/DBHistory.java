...
public class DBHistory {
    ...
    public DBHistory(String name, String pubDate, String channelName, String title, String desc, String imageurls1, String imageurls2, String imageurls3, String source, String channelId, String link, String html) {
        this.html = html;
        this.name = name;
